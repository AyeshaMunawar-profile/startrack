    ...
    return (
        <>
            <div className="sign-up-form center py-5 px-2 w-100">
                <Form className="text-off-white__0 fs-2 form form-transparent px-5 py-5 shadow sign-up-form-contents" onSubmit={handleSubmit}>
                    ...
                    <FormGroup className={"mt-5 row-space-between"}>
                        <FormGroup className="w-50">
                            <Label htmlFor={"firstName"} className={"pe-5 fs-3"}>First Name</Label>
                            <input className={"rounded-1 border-0 ps-3 px-5 fs-3 py-3 input input-first-name w-100"} name={"firstName"} type={"text"}
                        ...
                        <FormGroup className="w-50 ms-5">
                            <Label htmlFor={"lastName"} className={"pe-5 fs-3"}>Last Name</Label>
                            <input className={"rounded-1 border-0 ps-3 px-5 fs-3 py-3 input input-last-name w-100"} name={"lastName"} type={"text"}
                    ...
                    <FormGroup className={"column-right"}>
                        <Label htmlFor={"dateOfBirth"} className={"pe-5 fs-3"}>Date Of Birth</Label>
                        <DatePicker
                    ...
                    <FormGroup className={"column-right"}>
                        <Label htmlFor={"confirmPassword"} className={"pe-5 fs-3"}>Confirm Password</Label>
                        <input name={"confirmPassword"} type={"password"} id={"sign-up-confirm-password"} placeholder={""}
                    ...
                    <FormGroup check>
                        <Label check className={"fs-4"}>
                            <Input type="checkbox" className={"pl-0 mb-5 form-check-input input-remember-me"}
                                required
                            />{' '}
                            I accept the
                    ...
                    <Button type={"submit"}
                        ...
                        onClick={() => { if (!errors) { onRouteChange("home") } }}
                        value={"home"}
                    >Sign-up</Button>
                </Form>
            </div>
