import { ERROR_EMAIL_INVALID, EMPTY_PASSWORD, SHORT_PASSWORD, TEXT_EMPTY, AGE_NOT_ELIGIBLE, EMPTY_CONFIRM_PASSWORD, PASSWORD_MISMATCH, STRONG, MEDIUM, WEAK, strongRegex, mediumRegex } from '../common/js/Constants';
